...
description: Read Discord material or share user-approved text through the configured Discord MCP server and cross-reference it with repository code, tests, decisions, and documentation. Use when Codex needs to import meeting discussion, publish prepared text to a Discord channel, determine what repository evidence supports or contradicts a Discord claim, or relate repository material back to Discord without browser or computer automation.
---
