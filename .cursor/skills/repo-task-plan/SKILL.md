...
name: repo-task-plan
description: >-
  Inspect this repository and produce a bounded, evidence-backed implementation
  plan without changing files. Use when a validated Discord Codex job asks how a
  proposed game or service task fits the current architecture, tests, decisions,
