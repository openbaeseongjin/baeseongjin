...
description: >-
  Convert bounded Discord meeting minutes or message evidence into a read-only
  game-development plan for this repository. Use when a validated Discord Codex
  job supplies meeting content and asks for priorities, scoped work,
  verification, or risks without changing files or promoting ambiguous
