...
- Manual browser review: `PASS` — Stage 2-3 rendered the clustered cast-iron pitting, oxidation and dust treatment on the Support housing with its green role core preserved at desktop `1280x720` and mobile landscape `844x390`; no browser warnings or errors
