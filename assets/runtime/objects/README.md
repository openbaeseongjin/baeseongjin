...
- `boss-06-maintenance-shuttle`: Boss06 승리 후 `500×390` atlas를 `250×195`로 표시하는 Boarding 셔틀.
...
- Boss06 출발문은 visual 전체가 Departure Deck 안에 들도록 Deck 왼쪽에서 정렬하고, 셔틀은 실제 하단 착지 픽셀 anchor를 Deck top에 맞춘다. gameplay geometry와 상태 전이는 변경하지 않는다.
