...
그래픽 담당자의 기본 작업 시작점은 [`player-production-template`](./player-production-template)입니다. 이 폴더를 `assets/sprites/<character-id>/` sibling으로 복사하고 PNG와 manifest 값을 교체한 뒤 `npm run validate:sprite-assets -- <directory>`를 실행합니다. 상세 납품 계약은 [`docs/sprite-asset-format.md`](../../docs/sprite-asset-format.md)를 따릅니다.
