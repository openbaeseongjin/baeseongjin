...
| [`bsh/scenario/4/4-1/RUNTIME-HANDOFF.md`](./bsh/scenario/4/4-1/RUNTIME-HANDOFF.md) | 4-1 Runtime 구현 인계 — Guard A/B patrol 튜닝, Persistent Pursuit 상태 전이, 필수 테스트 목록 |
| [`bsh/scenario/4/4-1/VALIDATION.md`](./bsh/scenario/4/4-1/VALIDATION.md) | 4-1 정적 검증 근거 — Launch sample별 Base Rope attach margin, 남은 Dynamic/Blocked 검증 항목 |
| [`bsh/scenario/4/4-2/README.md`](./bsh/scenario/4/4-2/README.md) | `bsh` Sector 04 Stage(4-2) RESIDENTIAL COURTYARD Blockout 후보·제작 규격, REV 2.3 — Persistent Pursuit Stacking(Guard A→Guard B band 연계), Kill Optional |
| [`bsh/scenario/4/4-2/AREA-SPEC.json`](./bsh/scenario/4/4-2/AREA-SPEC.json) | 4-2 구현 계약(area-spec-v1) — Local ID·Route·Recovery·Persistent Pursuit newSystems·Acceptance Tests |
| [`bsh/scenario/4/4-2/RUNTIME-HANDOFF.md`](./bsh/scenario/4/4-2/RUNTIME-HANDOFF.md) | 4-2 Runtime 구현 인계 — Guard A/B patrol 튜닝, Pursuit Stacking 상태 전이, 필수 테스트 목록 |
| [`bsh/scenario/4/4-2/VALIDATION.md`](./bsh/scenario/4/4-2/VALIDATION.md) | 4-2 정적 검증 근거 — Launch sample별 Base Rope attach margin, 남은 Dynamic/Blocked 검증 항목 |
| [`bsh/scenario/4/4-3/README.md`](./bsh/scenario/4/4-3/README.md) | `bsh` Sector 04 Stage(4-3) SKY GARDEN TERRACES Blockout 후보·제작 규격, REV 2.3 — Crosswind + Guard Wind Drift(신규 시스템, NOT IMPLEMENTED), Persistent Pursuit 지속 |
| [`bsh/scenario/4/4-3/AREA-SPEC.json`](./bsh/scenario/4/4-3/AREA-SPEC.json) | 4-3 구현 계약(area-spec-v1) — Local ID·Route·Recovery·Wind Zone·Guard Wind Drift newSystems·Acceptance Tests |
| [`bsh/scenario/4/4-3/RUNTIME-HANDOFF.md`](./bsh/scenario/4/4-3/RUNTIME-HANDOFF.md) | 4-3 Runtime 구현 인계 — Guard A/B patrol 튜닝, Guard Wind Drift factor(0.30/0.12), 필수 테스트 목록 |
| [`bsh/scenario/4/4-3/VALIDATION.md`](./bsh/scenario/4/4-3/VALIDATION.md) | 4-3 정적 검증 근거 — Launch sample별 Base Rope attach margin, 남은 Dynamic/Blocked 검증 항목 |
| [`bsh/scenario/4/4-4/README.md`](./bsh/scenario/4/4-4/README.md) | `bsh` Sector 04 Stage(4-4) CARE PAVILION Blockout 후보·제작 규격, REV 2.4 — Guard 3기(A/B/C) 최대 3-Pursuer 누적, Treatment Pod(신규 시스템, NOT IMPLEMENTED) |
