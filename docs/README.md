...
| [`bsh/scenario/4/README.md`](./bsh/scenario/4/README.md) | `bsh` Sector 04 Transit/Infrastructure 마스터플랜(첫 Canonical 후보) — Cutter Fire·Transit Wake(기존 Wind 재사용)·Moving Platform Tech-Spike-Only, Stage 상세 문서는 아직 없음 |
