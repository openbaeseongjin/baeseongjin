...
10. 기존 공격·220px Bridge·Boarding을 유지하고 Boss snapshot v2는 상태·선택 sequence·가중치·motion과 현재 HP를 보존하며 지지면은 좌표로 다시 계산한다. Warden의 직접 Player 처치는 공통 Boss Runtime에서 현재 HP를 최대 HP 이내로 100 회복한다.
