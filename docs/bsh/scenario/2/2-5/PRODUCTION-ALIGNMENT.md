...
P0(-608~-352,0,256), P1(-512~-192,-160,320), S1(-512~-192,-352,320), P2(-256~448,-448,704), P3(224~512,-672,288), R1(64~320,-832,256), P4(32~320,-1024,288), Exit Deck(320~608,-1120,288) — 8개 Surface + Upper Transit Gate Blockade(§1 참고) + G1~G7 landmark 중심 전부 README §8과 정확히 일치.
