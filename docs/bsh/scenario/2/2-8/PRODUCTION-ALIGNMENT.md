...
> **CURRENT RUNTIME:** Sector-end Checkpoint·Transfer Control과 Sector 02 Access 3/3을 완료한 Player는 authored Gate portal로 3-1 Entry에 직접 이동한다. 2-8 내부 geometry·Enemy·Story objective는 바꾸지 않는다.
