...
| HP·생명·부활·아티팩트·보상 | 서버 claim 확정 snapshot | 로컬 체감 후 최신 권위 결과 즉시 흡수 | 최신 권위값 즉시 적용 | claim별 예측 피드백 해제 또는 권위 부활 상태 적용 |
