...
현재 전환이 끝난 범위는 자기 이동·로프·자기 공격 충돌·자기 피격·로프 절단·아티팩트 선택과 획득이다. 적 발사 생성, 체크포인트, 다운·부활 완료, 아티팩트 손실, 팀 패배·정상 도달의 서버 시작형 경로는 전환 대상이며 완료로 간주하지 않는다. 신규 구현은 이 미전환 구조를 본보기로 사용하지 않는다.
