...
| Pursuit·Shield·Artillery·Support·Swarm                        | behavior state의 `dashDirection`, `guardDirection`, `targetPosition + strikeRadius`, `targetId`, `recoilDirection` | converge/dash, guard flow/block, warning/strike, link stream, chase/recoil |
