...
| `sector-01-01:service-terminal` | terminal | `terminal-read` 완료 | cascade failure, Rooftop Pad 03 |
| `sector-01-01:service-gate` | gate | Terminal 뒤 `SERVICE SHAFT 02` 개방 | locked/unlocked/crossed |
...
| `sector-01-02:security-access-gate` | gate | Final Deck 도달 뒤 1-3 활성화 | security access check |
...
| `sector-01-03:service-panel` | terminal | `maintenance-override` 완료 | maintenance override, violation logged |
...
| `sector-01-04:test-bay-gate` | gate | Augment 선택 뒤 1-5 활성화 | `TEST BAY 05` |
...
| `sector-01-05:cooling-access-gate` | gate | Final Deck 도달 뒤 1-6 활성화 | cooling access preview |
...
| `sector-01-06:pressure-bypass-gate` | gate | Final Deck 도달 뒤 1-7 활성화 | bypass required |
...
| `sector-01-07:manual-bypass-control` | terminal | 위쪽 탈출 경로를 열고 `bypass-open` 완료 | manual pressure control |
...
| `sector-01-08:maintenance-override-panel` | terminal | `maintenance-override` 완료 | override lock/confirm |
