...
- [ ] **Step 1: Write a failing focused test for v2 identity, paired Anchor, editor policy, and behavior reference validation.**
...
- [ ] **Step 3: Implement the v2 model, Anchor expansion, behavior registry, and semantic validator.**
...
- [ ] **Step 5: Commit the isolated v2 model.**
