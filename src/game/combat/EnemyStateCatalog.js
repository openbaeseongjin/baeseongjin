...
export const ENEMY_BEHAVIOR_TRANSITIONS = Object.freeze({
    ...
    [ENEMY_BEHAVIOR_KIND.JAMMER]: transitions({ [JAMMER_BEHAVIOR_STATE.ROAM]: [] }),
    ...
    [ENEMY_BEHAVIOR_KIND.SWARM]: transitions({
        [SWARM_BEHAVIOR_STATE.CHASE]: [SWARM_BEHAVIOR_STATE.RECOIL],
        [SWARM_BEHAVIOR_STATE.RECOIL]: [SWARM_BEHAVIOR_STATE.CHASE]
    })
});
