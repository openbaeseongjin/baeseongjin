...
export class PolygonEnemyRenderer {
    ...
    drawDroneBody(context, enemy) {
        context.strokeStyle = "#94a3b8";
        context.lineWidth = 2;
        context.beginPath();
        context.moveTo(enemy.position.x - 20, enemy.position.y - 6);
        context.lineTo(enemy.position.x + 20, enemy.position.y - 6);
        context.stroke();
        context.fillStyle = "#334155";
        context.strokeStyle = "#fbbf24";
        context.lineWidth = 2;
        context.beginPath();
        context.arc(enemy.position.x, enemy.position.y, 12, 0, Math.PI * 2);
        context.fill();
        context.stroke();
        context.fillStyle = enemySensorColor(enemy);
        context.beginPath();
        context.arc(enemy.position.x, enemy.position.y, 4, 0, Math.PI * 2);
        context.fill();
    }
}
